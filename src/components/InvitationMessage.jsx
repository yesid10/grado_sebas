...
const InvitationMessage = () => {
    ...
    return (
        <section ref={sectionRef} className="relative flex justify-center items-center py-20 md:py-32 px-4">
            ...
            <div className="flex justify-center flex-col max-w-4xl gap-4 mx-auto h-auto">
                {/* Decorative Frame */}
                ...
                <div className={`mt-12 flex justify-center gap-8 transition-all duration-1000 delay-1000 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
                    <div className="text-center">
                        <div className="w-3 h-3 mx-auto mb-3 rounded-full bg-gradient-to-br from-[#f4d03f] to-[#d4af37] flex items-center justify-center">
